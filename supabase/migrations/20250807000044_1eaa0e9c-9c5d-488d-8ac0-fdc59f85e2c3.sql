...
-- Create comprehensive test data for system health using only 'healthy' status
-- since other status values may have constraints
...
('WebSocket Service', 'healthy', 289, NULL),
